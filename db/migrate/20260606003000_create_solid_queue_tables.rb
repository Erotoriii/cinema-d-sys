class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :solid_queue_processes do |t|
      ...
      t.index %i[name supervisor_id], unique: true, name: :index_solid_queue_processes_on_name_and_supervisor_id
    ...
    create_table :solid_queue_recurring_executions do |t|
      ...
      t.index %i[task_key run_at], unique: true, name: :index_solid_queue_recurring_executions_on_task_key_and_run_at
    end
